...
public class ProducerDemo {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        props.setProperty("bootstrap.servers", "hadoop202:9092,hadoop203:9092");
         ...
         * 代码中进行客户端参数配置的另一种写法
         */
        props.setProperty(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "hadoop202:9092,hadoop203:9092");
